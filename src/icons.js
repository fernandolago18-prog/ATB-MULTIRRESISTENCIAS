...
export const ICONS = {
    ...
    dna: svg('<path d="M2 15c6.667-6 13.333 0 20-6"/><path d="M9 22c1.798-1.998 2.518-3.995 2.807-5.993"/><path d="M15 2c-1.798 1.998-2.518 3.995-2.807 5.993"/><path d="m17 6-2.5-2.5"/><path d="m14 8-1-1"/><path d="m7 18 2.5 2.5"/><path d="m3.5 14.5.5.5"/><path d="m10 16 1 1"/>'),
    ...
    heartPulse: svg('<path d="M19.5 12.572l-7.5 7.428l-7.5-7.428A5 5 0 0 1 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3a5 5 0 0 1 2.995 9.572z"/><path d="M3.5 12h6l1-3 2 6 1.5-3h5.5"/>'),
    ...
    shieldAlert: svg('<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>'),
...
// Helper to create icon with custom size
export function icon(name, size = 20) {
    const paths = {
        microscope: '<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M8 6h4"/><path d="M13 3v7"/><path d="M9 3v7"/>',
